  ...
  return (
    <section className="py-24 relative overflow-hidden aurora">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div 
            className="relative rounded-3xl bg-gradient-hero p-8 sm:p-12 shadow-2xl overflow-hidden"
            whileHover={{ scale: 1.01 }}
            transition={{ type: "spring", stiffness: 300 }}
          >
            {/* Animated decorative glass elements */}
            <motion.div 
              className="absolute top-0 right-0 w-80 h-80 bg-white/10 rounded-full blur-3xl blob"
              animate={{ 
                x: [0, 40, 0],
                y: [0, -40, 0],
                scale: [1, 1.2, 1],
            ...
            />
            <motion.div 
              className="absolute bottom-0 left-0 w-80 h-80 bg-white/10 rounded-full blur-3xl blob"
              animate={{ 
                x: [0, -40, 0],
                y: [0, 40, 0],
                scale: [1.2, 1, 1.2],
            ...
            <FloatingElement className="absolute top-8 right-8" delay={0}>
              <motion.div 
                className="w-12 h-12 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center sparkle"
            ...
            <div className="relative z-10 text-center text-white">
              ...
              >
                ...
                >
                  <Button
                    size="lg"
                    variant="secondary"
                    className="h-14 px-8 whitespace-nowrap shadow-lg rounded-xl font-semibold group relative overflow-hidden"
              ...
              <motion.p 
                className="text-sm text-white/70 mt-6 flex items-center justify-center gap-2"
                initial={{ opacity: 0 }}
